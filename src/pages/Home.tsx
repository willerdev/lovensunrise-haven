...
import { Home as HomeIcon, Building2, MapPin, User, PlusCircle } from "lucide-react";
...
const propertyTypes: { value: PropertyType; label: string; icon: React.ReactNode }[] = [
  { value: "house_rent", label: "Houses for Rent", icon: <HomeIcon className="w-4 h-4" /> },
  { value: "house_sell", label: "Houses for Sale", icon: <HomeIcon className="w-4 h-4" /> },
